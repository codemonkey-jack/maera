...
class Site_Logo {
	...
	public function preview_enqueue() {
		wp_enqueue_script( 'site-logo-preview', trailingslashit( get_template_directory_uri() ) . 'includes/site-logo/js/site-logo.js', array( 'media-views' ), '', true );
		...
		if ( ! current_theme_supports( 'custom-header' ) ) {
			...
			wp_enqueue_script( 'site-logo-header-text', trailingslashit( get_template_directory_uri() ) . 'includes/site-logo//js/site-logo-header-text.js', array( 'media-views' ), '', true );
