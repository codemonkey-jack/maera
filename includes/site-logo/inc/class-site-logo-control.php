...
class Site_Logo_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'site-logo-control', trailingslashit( get_template_directory_uri() ) . 'includes/site-logo/css/site-logo-control.css' );
		wp_enqueue_script( 'site-logo-control', trailingslashit( get_template_directory_uri() ) . 'includes/site-logo/js/site-logo-control.js', array( 'media-views', 'customize-controls', 'underscore' ), '', true );
	}
