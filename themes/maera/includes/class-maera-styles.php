...
class Maera_Styles {
	...
	function scripts() {
		...
		wp_enqueue_script( 'maera-skip-link-focus-fix', trailingslashit( MAERA_THEME_URL ) . 'assets/js/skip-link-focus-fix.js', array(), '20130115', true );

		// Enqueue Modernizr
		wp_register_script( 'modernizr', trailingslashit( MAERA_THEME_URL ) . 'assets/js/modernizr.min.js', false, null, false );
		wp_enqueue_script( 'modernizr' );

		// Enqueue fitvids
		wp_register_script( 'fitvids', trailingslashit( MAERA_THEME_URL ) . 'assets/js/jquery.fitvids.js',false, null, true  );
		...
		wp_enqueue_style( 'socicon', trailingslashit( MAERA_THEME_URL ) . 'assets/css/socicon.css', false, MAERA_VERSION );
