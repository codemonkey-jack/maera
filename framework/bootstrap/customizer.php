...
function shoestrap_customizer_settings( $controls ) {
	...
	$controls[] = array(
		...
		'subtitle' => __( 'Select the width of your featured images on post archives. Set to -1 for max width and 0 for original width. Default: -1', 'shoestrap' ),
		'section'  => 'feat',
		'priority' => 52,
		'default'  => -1,
		'choices'  => array(
	...
	$controls[] = array(
		...
		'subtitle' => __( 'Select the height of your featured images on post archives. Set to 0 to resize the image using the original image proportions. Default: 0', 'shoestrap' ),
		'section'  => 'feat',
		'priority' => 53,
		'default'  => 0,
		'choices'  => array(
	...
	$controls[] = array(
		...
		'subtitle' => __( 'Select the width of your featured images on single posta. Set to -1 for max width and 0 for original width. Default: -1', 'shoestrap' ),
		'section'  => 'feat',
		'priority' => 62,
		'default'  => -1,
		'choices'  => array(
	...
	$controls[] = array(
		...
		'subtitle' => __( 'Select the height of your featured images on single posts. Set to 0 to use the original image proportions. Default: 0', 'shoestrap' ),
		'section'  => 'feat',
		'priority' => 63,
		'default'  => 0,
		'choices'  => array(
